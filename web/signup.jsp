        ...
        <div class="signup__container">
            <div class="container__child signup__thumbnail">
                <div class="thumbnail__logo">
                    ...
                    <h1 class="logo__text">Rental Car</h1>
                </div>
                <div class="thumbnail__content text-center">
                    <h1 class="heading--primary">Welcome to Rental Car Webpage.</h1>
                    <h2 class="heading--secondary">Are you ready to renting the best?</h2>
                </div>
            ...
            <div class="container__child signup__form">
                <form action="signUp" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="tel" name="txtPhone" id="username"  value="${param.txtPhone}" required pattern="[0-9]{10}" title="Phone: is number with 10 characters, Ex:'1234567890'"/>
                    </div>
                    <div class="form-group">
                        <label for="username">Address</label>
                        <input class="form-control" type="text" name="txtAddress" id="username" required value="${param.txtAddress}" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="m-t-lg">
                        <ul class="list-inline">
                            ...
                            <li>
                                <a class="signup__link" href="loginPage">I already have an account !! </a>
                            </li>
                            <font color="red">
